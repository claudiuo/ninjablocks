...
The module code is based on the cpu_module from the "Creating Modules for Fun and Profit" article by Nick Clark on the NinjaBlocks blog: http://ninjablocks.com/blogs/how-to/7355902-creating-modules-for-fun-and-profit
